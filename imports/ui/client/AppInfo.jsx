        ...
        return (
            <Modal show={this.props.show} onHide={this.hide.bind(this)}>
                <Modal.Header>
                    ...
                    <h5>by <a href="https://mcguinnessdr.com" target="_blank">mcguinnessdr</a></h5>
                </Modal.Header>
                <Modal.Body>
                <p style={style}>For help on how to use this, please take a look at the <a href="https://github.com/mcguinnessdr/DnDMap/wiki" target="_blank">wiki</a></p>
                <h4>Credits</h4>
